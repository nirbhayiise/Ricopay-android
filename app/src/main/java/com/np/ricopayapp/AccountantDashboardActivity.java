...
public class AccountantDashboardActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        UserPreference.init(AccountantDashboardActivity.this);
        ...
        name.setText(UserPreference.getAuth_names(AccountantDashboardActivity.this));
    }
        ...
        switch (id){
            ...
            case R.id.logout:
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(
                        AccountantDashboardActivity.this);
                ...
                builder.setPositiveButton("YES",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog,
                                ...
                                startActivity(new Intent(AccountantDashboardActivity.this, LoginActivity.class));
