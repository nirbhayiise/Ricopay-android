...
public class CashReceiverDashboardActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        UserPreference.init(CashReceiverDashboardActivity.this);
        ...
        name.setText(UserPreference.getAuth_names(CashReceiverDashboardActivity.this));
    }
        ...
        switch (id){
            ...
            case R.id.logout:
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(
                        CashReceiverDashboardActivity.this);
                ...
                builder.setPositiveButton("YES",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog,
                                ...
                                startActivity(new Intent(CashReceiverDashboardActivity.this, LoginActivity.class));
